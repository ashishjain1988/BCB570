...
Based on the results from part b we used both ARACNE2 and GENIE3 for predicting the GRNs. As mentioned earlier, we have used top quartile value as the threshold for filtreing the edges. The results for both of the yeast networks are attached.
