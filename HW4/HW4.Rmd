...
for(i in 1:5)
{
  filePath<-paste0("/home/jain/BCB570/Size_10/Size_10/DREAM4_training_data/insilico_size10_",i,"/")
  ...
  AUCWGCNA<-sintegral(WGCNA$V2,WGCNA$V1)$int
  AUCGEN<-sintegral(GEN$V2,GEN$V1)$int
  AUCARCNE<-sintegral(ARCNE$V2,ARCNE$V1)$int
  print(AUCARCNE)
  print(AUCGEN)
  print(AUCWGCNA)
