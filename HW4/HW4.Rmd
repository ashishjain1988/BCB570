...
public class PrecisionRecallCurveValues {
	...
	public static void main(String[] args) throws IOException{
		for(int f=1;f<=5;f++)
		{
			...
			BufferedReader br = new BufferedReader(new FileReader("./DREAM4_gold_standards/insilico_size10_"+f+"_goldstandard.tsv"));
			String line = br.readLine();
...
for(i in 1:5)
{
  ...
  AUCARCNE<-c(AUCARCNE,sintegral(ARCNE$V2,ARCNE$V1)$int)
...
table<-data.frame(Network=details,"AUC-ARCNE2" =AUCARCNE,"AUC-GENIE3"=AUCGEN,"AUC-WGCNA"=AUCWGCNA)
