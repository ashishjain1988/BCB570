...
ggplot(data=data, aes(x=degrees,y=degreeProbabilty))+
  geom_point() + labs(y="P(k)", x="Degree (k)",title="Degree Distribution") + theme(plot.title = element_text(hjust = 0.5))

ggplot(data=data, aes(x=cc,y=ccProb)) +
    geom_point() + labs(y="C(k)", x="k", title="Clustering Coefficient Distribution") + theme(plot.title = element_text(hjust = 0.5))
...
![](https://raw.githubusercontent.com/ashishjain1988/BCB570/master/HW2/Question2.jpg)

![](https://raw.githubusercontent.com/ashishjain1988/BCB570/master/HW2/Question3.jpg)